...
app = FastAPI(
    title="GPT-Realtime-Whisper Live Transcript Redactor API",
    description=(
        "Realtime transcription + layered redaction pipeline backed by "
        "Backblaze B2 — session bundles, exports, custom glossary."
    ),
    version="0.1.0",
    lifespan=lifespan,
)
