...
# /upload is the realtime-pipeline ingest endpoint — audio only. The full
# bucket explorer (/files) still surfaces all object types because B2 is
# the storage of record for many tools, not just this app.
ALLOWED_TYPES = {
    "audio/mpeg",
    "audio/wav",
    "audio/webm",
